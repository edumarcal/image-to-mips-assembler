...
public class ImageToAssembleMips_1 {
            ...
            for (int linha = 0; linha < altura; linha++) {
                ...
                for (int coluna = 0; coluna < largura; coluna++) {
                    ...
                    } else if(coluna==0)
                    {
                       ...
                       codigo += "\tsub $a1,$a1," + (aux+1) + "\t#coluna = " + String.valueOf(coluna+1) + "\n";
                    }
                    
                        if(corAnterior!=corAtual && !"0xffffff".equalsIgnoreCase(hexa))
                    {
                        aux = coluna;
                       ...
                       // codigo += "\tjal Plot\n";
                        ...
                        else if(!"0xffffff".equalsIgnoreCase(hexa)){
                        codigo += "\tadd $a1,$a1," + 1 + "\t#coluna = " + String.valueOf(coluna+1) + "\n";
                        codigo += "\tjal Plot\n";
                        }
